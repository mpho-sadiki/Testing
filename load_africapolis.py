...
def get_africapolis(
    ...
    layer : str
        Africapolis layer to load ('africapolis_2015' or 'africapolis_2020'). Defaults to 'africapolis_2020'.
    drop_wms : bool
    ...
    describe_url = (
        f"https://geoserver.dev.digitalearth.africa/geoserver/wms?service=WMS&version=1.1.1&"
